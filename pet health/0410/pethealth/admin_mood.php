...
<?php
        session_start();
        $link=mysqli_connect('127.0.0.1', 'root', '', '4007') or die('Failed to connect or select database');
        mysqli_set_charset($link, 'utf8mb4d');
    ...
    <div class="content-wrapper">
        ...
        <div class="mdc-drawer__content">
            ...
            <a class="mdc-deprecated-list-item" href="admin_food.php" aria-current="page">
                ...
                <span class="mdc-deprecated-list-item__text">Food</span>
            </a>
            ...
            <a class="mdc-deprecated-list-item" href="admin_waste.php">
                <span class="mdc-deprecated-list-item__ripple"></span>
                <i class="material-icons mdc-deprecated-list-item__graphic" aria-hidden="true">folder</i>
            <span class="mdc-deprecated-list-item__text">Waste</span>  
            </a>  
            <a class="mdc-deprecated-list-item" href="admin_daily.php">
                <span class="mdc-deprecated-list-item__ripple"></span>
                <i class="material-icons mdc-deprecated-list-item__graphic" aria-hidden="true">folder</i>
                <span class="mdc-deprecated-list-item__text">Daily</span>
            </a>
        </div>
        </aside>    
                    ...
                    <div class="mdc-dialog__surface"
                        ...
                        <div class="mdc-dialog__content" id="my-dialog-content">
                            <h3>Add New Record</h3>
                                <label for="mood_record_no">Mood Record No:</label>
                                <input type="mood_record_no" name="mood_record_no" id="mood_record_no" required><br>
                                ...
                                <input type="mood_date" name="mood_date" id="mood_date" required><br>
                                <label for="photo">Photo:</label>
                                <input type="photo" name="photo" id="photo" required><br>
                                <div class="mdc-form-field">
                                <div class="mdc-radio">
                                    <input class="mdc-radio__native-control" type="radio" id="happy" name="mood_type" checked>
                                ...
                                <div class="mdc-radio">
                                    <input class="mdc-radio__native-control" type="radio" id="sad" name="mood_type">
                                    <div class="mdc-radio__background">
                                    <div class="mdc-radio__outer-circle"></div>
                                    <div class="mdc-radio__inner-circle"></div>
                                    </div>
                                ...
                                <div class="mdc-radio">
                                    <input class="mdc-radio__native-control" type="radio" id="angry" name="mood_type">
                                    <div class="mdc-radio__background">
                                    <div class="mdc-radio__outer-circle"></div>
                                    <div class="mdc-radio__inner-circle"></div>
                                    </div>
                                ...
                                <div class="mdc-radio">
                                    <input class="mdc-radio__native-control" type="radio" id="others" name="mood_type">
                                    <div class="mdc-radio__background">
                                    <div class="mdc-radio__outer-circle"></div>
                                    <div class="mdc-radio__inner-circle"></div>
                                    </div>
        ...
        <div class="mdc-dialog__surface"
            ...
            <form action="admin_user_update.php" method="post">
                <div class="mdc-dialog__content" id="my-dialog-content">
                    ...
                    <input type="text" id="u_mood_record_no" name="u_mood_record_no" value="<?php echo $userDetails['mood_record_no']; ?>" required><br>

                    <label for="u_pet_no">Pet No:</label>
                    <input type="pet_no" id="u_pet_no" name="u_pet_no" value="<?php echo $userDetails['pet_no']; ?>" required><br>
                    ...
                    <input type="text" id="u_photo" name="u_photo" value="<?php echo $userDetails['photo']; ?>" required><br>

                    <label for="u_mood_date">Mood Date:</label>
                    <input type="text" id="u_mood_date" name="u_mood_date" value="<?php echo $userDetails['mood_date']; ?>" required><br>
                </div>
                <div class="mdc-dialog__actions">
                    <button type="button" class="mdc-button mdc-dialog__button" data-mdc-dialog-action="cancel">
                        <div class="mdc-button__ripple"></div>
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if (xhr.status === 200) {
                        ...
                        // 在这里填充弹窗中的表单字段
                        document.getElementById("u_user_id").value = moodDetails.user_id;
                        document.getElementById("u_mood_record_no").value = moodDetails.mood_record_no;
                        document.getElementById("u_photo").value = moodDetails.photo;
